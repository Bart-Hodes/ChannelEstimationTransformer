...
plt.plot(x_values, mean_values, label="INQ Proximal", marker="o", color="#FF9500")
...
plt.plot(x_values, mean_values, label="INQ Stochastic", marker="o", color="#845B97")
...
plt.savefig("QAT_loss_LSQ.png", dpi=300)
plt.close()
