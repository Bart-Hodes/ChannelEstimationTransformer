...
__global__ void fixed_point_quantize_partial_proximal_kernel(float *__restrict__ a,
                                                             float *o, int size,
                                                             int sigma, bool use_clamp,
                                                             float t_min, float t_max, float threshold)
{
...
__global__ void fixed_point_quantize_partial_distant_kernel(float *__restrict__ a,
                                                            float *o, int size,
                                                            int sigma, bool use_clamp,
                                                            float t_min, float t_max, float threshold)
{
...
__global__ void fixed_point_quantize_partial_stochastic_kernel(float *__restrict__ a,
                                                               float *o, int size,
                                                               int sigma, bool use_clamp,
                                                               float t_min, float t_max, float percentage)
{
