...
Tensor fibonacci_quantize_partial_proximal(Tensor a, int wl, int fl, bool use_clamp, bool symmetric, float percentage)
{
    CHECK_INPUT(a);
    return fibonacci_quantize_partial_proximal_cuda(a, wl, fl, use_clamp, symmetric, percentage);
}

Tensor fibonacci_quantize_partial_distant(Tensor a, int wl, int fl, bool use_clamp, bool symmetric, float percentage)
{
    CHECK_INPUT(a);
    return fibonacci_quantize_partial_distant_cuda(a, wl, fl, use_clamp, symmetric, percentage);
}

Tensor fibonacci_quantize_partial_stochastic(Tensor a, int wl, int fl, bool use_clamp, bool symmetric, float percentage)
{
    CHECK_INPUT(a);
    return fibonacci_quantize_partial_stochastic_cuda(a, wl, fl, use_clamp, symmetric, percentage);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("fibonacci_quantize_partial_proximal", &fibonacci_quantize_partial_proximal, "Fixed Point Number Nearest Neighbor Quantization (CUDA)");
    m.def("fibonacci_quantize_partial_distant", &fibonacci_quantize_partial_distant, "Fixed Point Number Nearest Neighbor Quantization (CUDA)");
    m.def("fibonacci_quantize_partial_stochastic", &fibonacci_quantize_partial_stochastic, "Fixed Point Number Nearest Neighbor Quantization (CUDA)");
