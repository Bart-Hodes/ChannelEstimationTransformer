...
Tensor fixed_point_quantize_partial_nearest(Tensor a, int wl, int fl, bool use_clamp, bool symmetric, float percentage)
{
  CHECK_INPUT(a);
  return fixed_point_quantize_partial_cuda(a, wl, fl, use_clamp, symmetric, percentage);
}


Tensor noAdjecentOnes_quantize_nearest(Tensor a, int wl, int fl, bool use_clamp, bool symmetric)
{
  CHECK_INPUT(a);
  return noAdjecentOnes_quantize_nearest_cuda(a, wl, fl, use_clamp, symmetric);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("fixed_point_quantize_partial_nearest", &fixed_point_quantize_partial_nearest, "Fixed Point Number Nearest Neighbor Quantization (CUDA)");
  ...
  m.def("noAdjecentOnes_quantize_nearest", &noAdjecentOnes_quantize_nearest, "Fixed Point Number Nearest Neighbor Quantization (CUDA)");
